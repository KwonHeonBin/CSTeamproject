...
import com.example.cud.ui.draw.CanvasManager.Companion.saveCanvas
                    ...
                    when (mode) {
                        ...
                        1 -> {    // point delete
                            ...
                            if(index in 1..st.point.size-2){ // 점이 중간 지점에 있을 때
                                ...
                                pathList.add(pathList.indexOf(st),path1)// 새롭게 생성된 선을 리스트에 추가
                                pathList.add(pathList.indexOf(st),path2)
